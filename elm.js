...
var _ohanhi$elm_native_ui$NativeUi_ListView$scrollRenderAheadDistance = function (_p0) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'scrollRenderAheadDistance',
		_elm_lang$core$Json_Encode$int(_p0));
};
var _ohanhi$elm_native_ui$NativeUi_ListView$removeClippedSubviews = function (_p1) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'removeClippedSubviews',
		_elm_lang$core$Json_Encode$bool(_p1));
};
var _ohanhi$elm_native_ui$NativeUi_ListView$pageSize = function (_p2) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'pageSize',
		_elm_lang$core$Json_Encode$int(_p2));
};
var _ohanhi$elm_native_ui$NativeUi_ListView$initialListSize = function (_p3) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'initialListSize',
		_elm_lang$core$Json_Encode$int(_p3));
};
var _ohanhi$elm_native_ui$NativeUi_ListView$unencodedProperty = _ohanhi$elm_native_ui$Native_NativeUi_ListView.unencodedProperty;
var _ohanhi$elm_native_ui$NativeUi_ListView$updateDataSource = _ohanhi$elm_native_ui$Native_NativeUi_ListView.updateDataSource;
var _ohanhi$elm_native_ui$NativeUi_ListView$emptyDataSource = _ohanhi$elm_native_ui$Native_NativeUi_ListView.emptyDataSource;
var _ohanhi$elm_native_ui$NativeUi_ListView$renderRow = _ohanhi$elm_native_ui$NativeUi$renderProperty('renderRow');
var _ohanhi$elm_native_ui$NativeUi_ListView$listView = F3(
	function (ds, render, props) {
		return A3(
			_ohanhi$elm_native_ui$NativeUi$node,
			'ListView',
			{
				ctor: '::',
				_0: _ohanhi$elm_native_ui$NativeUi_ListView$unencodedProperty(ds),
				_1: {
					ctor: '::',
					_0: _ohanhi$elm_native_ui$NativeUi_ListView$renderRow(render),
					_1: props
				}
			},
			{ctor: '[]'});
	});
var _ohanhi$elm_native_ui$NativeUi_ListView$DataSource = function (a) {
	return {ctor: 'DataSource', _0: a};
};

var _ohanhi$elm_native_ui$Main$disabledButton = F2(
				...
				_0: _ohanhi$elm_native_ui$NativeUi$style(
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi_Style$backgroundColor(color),
								_1: {
									ctor: '::',
													...
													_1: {
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _ohanhi$elm_native_ui$NativeUi_Style$borderStyle('solid'),
																	_1: {
																		ctor: '::',
																		_0: _ohanhi$elm_native_ui$NativeUi_Style$borderRadius(15.0),
																		_1: {
																			ctor: '::',
																			_0: _ohanhi$elm_native_ui$NativeUi_Style$borderColor(color),
																			_1: {ctor: '[]'}
																		}
																	}
																}
...
var _ohanhi$elm_native_ui$Main$button = F3(
...
var _ohanhi$elm_native_ui$Main$newTask = F2(
	function (i, name) {
		return {id: i + 1, name: name, time: 0.0};
	});
var _ohanhi$elm_native_ui$Main$newProject = F2(
	function (i, name) {
		return {
			id: i + 1,
			name: name,
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
							...
							model,
							{
								projects: A2(
									...
									model.projects,
									{
										ctor: '::',
										_0: A2(
											_ohanhi$elm_native_ui$Main$newProject,
											_elm_lang$core$List$length(model.projects),
											_p1._0),
										_1: {ctor: '[]'}
									})
							}),
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								projects: A2(
									_elm_lang$core$List$map,
									function (project) {
										return _elm_lang$core$Native_Utils.eq(project.id, _p0._0) ? {
											id: project.id,
											name: project.name,
											...
											tasks: A2(
												...
												project.tasks,
												{
													ctor: '::',
													_0: A2(
														_ohanhi$elm_native_ui$Main$newTask,
														_elm_lang$core$List$length(project.tasks),
														_p2._0),
													_1: {ctor: '[]'}
												})
										} : project;
			...
			case 'InputProjectName':
				var _p3 = _p0._0;
				return _elm_lang$core$String$isEmpty(_p3) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{tmpProjectName: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							tmpProjectName: _elm_lang$core$Maybe$Just(_p3)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'InputTaskName':
				...
				return _elm_lang$core$String$isEmpty(_p4) ? {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{tmpTaskName: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							tmpTaskName: _elm_lang$core$Maybe$Just(_p4)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ClickProject':
							...
							projects: A2(
								...
								function (project) {
									return {
										id: project.id,
										name: project.name,
										status: _elm_lang$core$Native_Utils.eq(project.id, _p0._0),
										tasks: project.tasks
									};
								},
								model.projects)
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							projects: A2(
								_elm_lang$core$List$map,
								function (project) {
									return {id: project.id, name: project.name, status: false, tasks: project.tasks};
								},
								model.projects)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
...
var _ohanhi$elm_native_ui$Main$tasksOutput = function (l) {
	var _p5 = l;
	if (_p5.ctor === '[]') {
		return {ctor: '[]'};
	} else {
		return {
			...
			_0: A2(
					...
					_0: _ohanhi$elm_native_ui$NativeUi$style(
						{
							...
							_1: {
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi_Style$color('#00ccff'),
								_1: {
									ctor: '::',
									_0: _ohanhi$elm_native_ui$NativeUi_Style$marginBottom(20),
									_1: {
										ctor: '::',
										_0: _ohanhi$elm_native_ui$NativeUi_Style$width(100),
										_1: {
											ctor: '::',
											_0: _ohanhi$elm_native_ui$NativeUi_Style$borderStyle('solid'),
											_1: {
												ctor: '::',
												_0: _ohanhi$elm_native_ui$NativeUi_Style$borderBottomColor('#003340'),
												_1: {
													ctor: '::',
													_0: _ohanhi$elm_native_ui$NativeUi_Style$borderBottomWidth(1),
													_1: {ctor: '[]'}
												}
											}
										}
				...
				{
					ctor: '::',
					_0: _ohanhi$elm_native_ui$NativeUi$string(_p5._0.name),
					_1: {ctor: '[]'}
				}),
			_1: _ohanhi$elm_native_ui$Main$tasksOutput(_p5._1)
		};
	}
};
var _ohanhi$elm_native_ui$Main$dummyList = {
	ctor: '::',
	_0: {
		id: 1,
		name: 'elm',
...
var _ohanhi$elm_native_ui$Main$initModel = {
	ctor: '_Tuple2',
	_0: {projects: _ohanhi$elm_native_ui$Main$dummyList, tmpProjectName: _elm_lang$core$Maybe$Nothing, tmpTaskName: _elm_lang$core$Maybe$Nothing},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _ohanhi$elm_native_ui$Main$Task = F3(
	function (a, b, c) {
		return {id: a, name: b, time: c};
	});
var _ohanhi$elm_native_ui$Main$Project = F4(
	function (a, b, c, d) {
		return {id: a, name: b, status: c, tasks: d};
	});
var _ohanhi$elm_native_ui$Main$Model = F3(
	function (a, b, c) {
		return {projects: a, tmpProjectName: b, tmpTaskName: c};
	});
var _ohanhi$elm_native_ui$Main$BackToProjects = {ctor: 'BackToProjects'};
var _ohanhi$elm_native_ui$Main$ClickProject = function (a) {
	return {ctor: 'ClickProject', _0: a};
};
var _ohanhi$elm_native_ui$Main$projectOutput = function (l) {
	var _p6 = l;
	if (_p6.ctor === '[]') {
		return {ctor: '[]'};
	} else {
		...
		return {
			...
			_0: A2(
				_ohanhi$elm_native_ui$NativeUi_Elements$text,
				{
					...
					_1: {
						ctor: '::',
						_0: _ohanhi$elm_native_ui$NativeUi_Events$onPress(
							_ohanhi$elm_native_ui$Main$ClickProject(_p7.id)),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _ohanhi$elm_native_ui$NativeUi$string(_p7.name),
					_1: {ctor: '[]'}
				}),
			_1: _ohanhi$elm_native_ui$Main$projectOutput(_p6._1)
		};
	}
};
var _ohanhi$elm_native_ui$Main$InputTaskName = function (a) {
	return {ctor: 'InputTaskName', _0: a};
};
var _ohanhi$elm_native_ui$Main$InputProjectName = function (a) {
	return {ctor: 'InputProjectName', _0: a};
};
var _ohanhi$elm_native_ui$Main$AddTask = function (a) {
	return {ctor: 'AddTask', _0: a};
};
var _ohanhi$elm_native_ui$Main$AddProject = {ctor: 'AddProject'};
var _ohanhi$elm_native_ui$Main$view = function (model) {
	var filteredProject = A2(
		_elm_lang$core$List$filter,
		function (project) {
			return project.status;
		},
		model.projects);
	var singleProject = _elm_lang$core$List$head(filteredProject);
	return _elm_lang$core$List$isEmpty(filteredProject) ? A2(
			...
			_0: _ohanhi$elm_native_ui$NativeUi$style(
				{
					...
					_1: {
						ctor: '::',
						_0: _ohanhi$elm_native_ui$NativeUi_Style$backgroundColor('#ffffff'),
						_1: {
							ctor: '::',
							_0: _ohanhi$elm_native_ui$NativeUi_Style$height(960.0),
							_1: {ctor: '[]'}
						}
					}
				}),
			...
			_0: A2(
				_ohanhi$elm_native_ui$NativeUi_Elements$view,
				{
					...
					_0: _ohanhi$elm_native_ui$NativeUi$style(
						{
							ctor: '::',
							_0: _ohanhi$elm_native_ui$NativeUi_Style$width(540),
							_1: {
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi_Style$height(80),
								_1: {
									ctor: '::',
									_0: _ohanhi$elm_native_ui$NativeUi_Style$backgroundColor('#003340'),
									_1: {ctor: '[]'}
								}
							}
						}),
				...
				},
				{
					...
					_0: A2(
							...
							_0: _ohanhi$elm_native_ui$NativeUi$style(
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _ohanhi$elm_native_ui$NativeUi_Style$marginTop(15),
											_1: {
												ctor: '::',
												_0: _ohanhi$elm_native_ui$NativeUi_Style$fontSize(35),
												_1: {ctor: '[]'}
											}
										}
									}
						...
						{
							ctor: '::',
							_0: _ohanhi$elm_native_ui$NativeUi$string('Arbeitszeit'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: A2(
							_ohanhi$elm_native_ui$NativeUi_Elements$textInput,
							{
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi$style(
									{
										...
										_1: {
											ctor: '::',
											_0: _ohanhi$elm_native_ui$NativeUi_Style$color('#003340'),
											_1: {
												ctor: '::',
												_0: _ohanhi$elm_native_ui$NativeUi_Style$width(100),
												_1: {ctor: '[]'}
							...
							{
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi$string('Projecte'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
							...
							_0: _ohanhi$elm_native_ui$NativeUi$style(
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _ohanhi$elm_native_ui$NativeUi_Style$height(330),
											_1: {
												ctor: '::',
												_0: _ohanhi$elm_native_ui$NativeUi_Style$overflow('visible'),
												_1: {ctor: '[]'}
											}
										}
									}
							...
							_0: A2(
								_ohanhi$elm_native_ui$NativeUi_Elements$view,
								{
									...
									_0: _ohanhi$elm_native_ui$NativeUi$style(
										{
											ctor: '::',
											_0: _ohanhi$elm_native_ui$NativeUi_Style$marginTop(25),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
								_ohanhi$elm_native_ui$Main$projectOutput(model.projects)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
							...
							},
							{
									...
									},
									{
										...
										_0: A2(
											_ohanhi$elm_native_ui$NativeUi_Elements$textInput,
											{
												...
												_0: _ohanhi$elm_native_ui$NativeUi$style(
													{
														...
														_1: {
															ctor: '::',
															_0: _ohanhi$elm_native_ui$NativeUi_Style$marginBottom(10),
															_1: {
																ctor: '::',
																_0: _ohanhi$elm_native_ui$NativeUi_Style$width(100),
																_1: {ctor: '[]'}
												...
												_1: {
													ctor: '::',
													_0: _ohanhi$elm_native_ui$NativeUi_Events$onChangeText(_ohanhi$elm_native_ui$Main$InputProjectName),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _ohanhi$elm_native_ui$NativeUi$string('Add Project'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(model.tmpProjectName, _elm_lang$core$Maybe$Nothing) ? A2(_ohanhi$elm_native_ui$Main$disabledButton, '#f00', '+') : A3(_ohanhi$elm_native_ui$Main$button, _ohanhi$elm_native_ui$Main$AddProject, '#00ccff', '+'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
									...
									_0: _ohanhi$elm_native_ui$NativeUi$style(
										{
											...
											_1: {
												ctor: '::',
												_0: _ohanhi$elm_native_ui$NativeUi_Style$height(60),
												_1: {
													ctor: '::',
													_0: _ohanhi$elm_native_ui$NativeUi_Style$bottom(-20),
													_1: {
														ctor: '::',
														_0: _ohanhi$elm_native_ui$NativeUi_Style$backgroundColor('#003340'),
														_1: {ctor: '[]'}
				...
				},
				{
					...
					_0: A2(
						_ohanhi$elm_native_ui$NativeUi_Elements$text,
						{
							...
							_0: _ohanhi$elm_native_ui$NativeUi$style(
								{
									...
									_1: {
										ctor: '::',
										_0: _ohanhi$elm_native_ui$NativeUi_Style$textAlign('left'),
										_1: {
											ctor: '::',
											_0: _ohanhi$elm_native_ui$NativeUi_Style$backgroundColor('white'),
											_1: {
												ctor: '::',
												_0: _ohanhi$elm_native_ui$NativeUi_Style$paddingTop(5),
												_1: {
													...
													_1: {
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _ohanhi$elm_native_ui$NativeUi_Style$marginRight(30),
																	_1: {
																		ctor: '::',
																		_0: _ohanhi$elm_native_ui$NativeUi_Style$fontWeight('bold'),
																		_1: {
																						...
																						_1: {
																							...
																							_1: {
																								...
																								_1: {
																									...
																									_1: {
																										ctor: '::',
																										_0: _ohanhi$elm_native_ui$NativeUi_Style$borderColor('white'),
																										_1: {ctor: '[]'}
																									}
																								}
																							}
							...
							_1: {
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi_Events$onPress(_ohanhi$elm_native_ui$Main$BackToProjects),
								_1: {ctor: '[]'}
							}
						},
						{
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi$string('Aufgaben'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								_ohanhi$elm_native_ui$Main$tasksOutput(
									function () {
										var _p9 = singleProject;
										if (_p9.ctor === 'Nothing') {
											return {ctor: '[]'};
										} else {
											return _p9._0.tasks;
							...
							},
							{
									...
									},
									{
										...
										_0: A2(
											_ohanhi$elm_native_ui$NativeUi_Elements$textInput,
											{
												...
												_1: {
													ctor: '::',
													_0: _ohanhi$elm_native_ui$NativeUi_Events$onChangeText(_ohanhi$elm_native_ui$Main$InputTaskName),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _ohanhi$elm_native_ui$NativeUi$string('Add Task'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(model.tmpTaskName, _elm_lang$core$Maybe$Nothing) ? A2(_ohanhi$elm_native_ui$Main$disabledButton, '#f00', '+') : A3(
												_ohanhi$elm_native_ui$Main$button,
												_ohanhi$elm_native_ui$Main$AddTask(
													function () {
														var _p10 = singleProject;
...
var _ohanhi$elm_native_ui$Main$main = _ohanhi$elm_native_ui$NativeUi$program(
	{
		init: _ohanhi$elm_native_ui$Main$initModel,
